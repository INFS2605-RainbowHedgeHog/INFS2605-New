 ...
 *
 *
 *	File: MemberPayment.java
 *	Description: MemberPayment class
...
public class MemberPayment extends Payment {
    ...
    public MemberPayment(int recieptNo, int amount, int userID, long fromAcctNo, long toAcctNo, String paymentMedia) {
